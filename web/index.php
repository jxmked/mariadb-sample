...
<head>
    ...
    <link rel="preload" href="<?php Helpers::safe_print(RESOURCE_ROOT); ?>assets/fonts/montserrat/Montserrat-Medium.woff2" as="font" />
    <link rel="preload" href="<?php Helpers::safe_print(RESOURCE_ROOT); ?>assets/fonts/montserrat/Montserrat-SemiBold.woff2" as="font" />
...
<body class="">
    ...
    <div id="bg-cover" data-status="hide"></div>

    <?php if (Helpers::url_param("page") == 'program') : ?>
        <!-- Methods -->
        ...
        <div class="container form-page">
            <div>
                ...
                <div id="confirm-delete-dialog" data-status="hidden" data-id="" hidden>
                    <div>
    ...
    <?php elseif (Helpers::url_param("page") == 'intro') : ?>
        <!-- Landing Page -->
        <div class="container">
            <div>
