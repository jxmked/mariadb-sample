...
const EMPTY_FIELD: string = "Oppsss... Either field cannot be empty and must contain only letters and/or dash '-'";
const INVALID_FIELD_DATA: string = "Please, fill up the form accordingly";
...
export default class AddCat {
    ...
    constructor() {
        if (AddCat.hasBeenCalled)
            throw new Error("AddCat cannot reinitiate");
