...
class Hosted_PHP_API(phpapi_model):
    ...
    def insert(self, **args):
        ...
        if None in [name, color]:
            raise Exception(
                "Hosted_PHP_API.insert should have name and color arguments")
    ...
    def get(self, _id):
        ...
        if _id is None:
            raise Exception(
                "Hosted_PHP_API.get parameter must be an id, None given")
    ...
    def update(self, **args):
        ...
        if _id is None:
            raise Exception(
                "Hosted_PHP_API.update parameter must be an id, None given")

        if None in [_id, name, color]:
            raise Exception(
                "Hosted_PHP_API.update should have id, name and color arguments")
